...
public class Explanation : MonoBehaviour//, IPointerDownHandler, IPointerUpHandler
{
    ...
    private bool isExplanationVisible = false;

    // This method will toggle the active state of _ExplanationGO
    public void ToggleExplanation()
    {
        // Toggle the active state
        isExplanationVisible = !isExplanationVisible;
        _ExplanationGO.SetActive(isExplanationVisible);

        Debug.Log("Explanation visibility toggled: " + isExplanationVisible);
    }
